...
class NativeSmileID: NSObject {
    ...
    public  func setCallbackUrl(callbackUrl: String, resolve: @escaping RCTPromiseResolveBlock, reject _: @escaping RCTPromiseRejectBlock) {
        SmileID.setCallbackUrl(url: URL(string: callbackUrl))
        resolve(nil)
    }

    @objc(setAllowOfflineMode:withResolver:withRejecter:)
    public   func setAllowOfflineMode(allowOfflineMode: Bool, resolve: @escaping RCTPromiseResolveBlock, reject _: @escaping RCTPromiseRejectBlock) {
        SmileID.setAllowOfflineMode(allowOfflineMode: allowOfflineMode)
        resolve(nil)
    }

    @objc(submitJob:withResolver:withRejecter:)
    public  func submitJob(jobId: String, resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
        do {
    ...
    public   func getSubmittedJobs(resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
        do {
    ...
    public  func getUnsubmittedJobs(resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
        do {
            let jobs: [String] = SmileID.getUnsubmittedJobs()
            resolve(jobs)
        } catch let error as NSError {
    ...
    public   func cleanup(jobId: String, resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
        do {
    ...
    public   func authenticate(request: NSDictionary, resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
    ...
    public   func prepUpload(request: NSDictionary, resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
    ...
    public  func upload(url: String, request: NSDictionary, resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
    ...
    public  func doEnhancedKyc(request: NSDictionary, resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
    ...
    public  func doEnhancedKycAsync(request: NSDictionary, resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
        guard let partnerParamsDict = request["partnerParams"] as? NSDictionary else {
            reject("doEnhancedKyc", "partnerParams is required", nil)
            return
        }
    ...
    public  func getSmartSelfieJobStatus(request: NSDictionary, resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
    ...
    public  func getDocumentVerificationJobStatus(request: NSDictionary, resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
        getJobStatus(request: request, resolve: resolve, reject: reject)
    }

    @objc(getBiometricKycJobStatus:withResolver:withRejecter:)
    public  func getBiometricKycJobStatus(request: NSDictionary, resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
        getJobStatus(request: request, resolve: resolve, reject: reject)
    }

    @objc(getEnhancedDocumentVerificationJobStatus:withResolver:withRejecter:)
    public  func getEnhancedDocumentVerificationJobStatus(request: NSDictionary, resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
        getJobStatus(request: request, resolve: resolve, reject: reject)
    }

    @objc(getProductsConfig:withResolver:withRejecter:)
    public  func getProductsConfig(request: NSDictionary, resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
    ...
    public  func getValidDocuments(request: NSDictionary, resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
    ...
    public  func getServices(resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
        Task {
            do {
    ...
    public  func getJobStatus(request: NSDictionary, resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
    ...
    public  func pollSmartSelfieJobStatus(request: NSDictionary, resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
        guard let jobStatusRequest = request.toJobStatusRequest() else {
            reject("Error", "Invalid job status request", nil)
            return
        }
    ...
    public  func pollDocumentVerificationJobStatus(request: NSDictionary, resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
        guard let jobStatusRequest = request.toJobStatusRequest() else {
            reject("Error", "Invalid job status request", nil)
            return
        }
    ...
    public  func pollBiometricKycJobStatus(request: NSDictionary, resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
        guard let jobStatusRequest = request.toJobStatusRequest() else {
            reject("Error", "Invalid job status request", nil)
            return
        }
    ...
    public  func pollEnhancedDocumentVerificationJobStatus(request: NSDictionary, resolve: @escaping RCTPromiseResolveBlock, reject: @escaping RCTPromiseRejectBlock) {
        guard let jobStatusRequest = request.toJobStatusRequest() else {
            reject("Error", "Invalid job status request", nil)
            return
        }
   ...
   public  func pollJobStatus<RequestType, T: JobResult>(
   ...
   @objc public  func convertToTimeInterval(milliSeconds: Int64) -> TimeInterval {
