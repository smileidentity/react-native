...
RCT_EXTERN_METHOD(getUnsubmittedJobs:(RCTPromiseResolveBlock)resolve withRejecter:(RCTPromiseRejectBlock)reject)
RCT_EXTERN_METHOD(getSubmittedJobs:(RCTPromiseResolveBlock)resolve withRejecter:(RCTPromiseRejectBlock)reject)
