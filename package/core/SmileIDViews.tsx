...
if (PlatformDetector.getPlatform() === 'expo') {
  createSmileIDView = require('../platforms/expo/useSmileIDExpoView').createSmileIDView;
} else {
  createSmileIDView = require('../platforms/react-native/useSmileIDRNView').createSmileIDView;
}
...
export const SmileIDConsentView = createSmileIDView<ConsentRequest>(
  'SmileIDConsentView'
);
...
export const SmileIDDocumentVerificationView = createSmileIDView<DocumentVerificationRequest>(
  'SmileIDDocumentVerificationView'
);

export const SmileIDEnhancedDocumentVerificationView = createSmileIDView<EnhancedDocumentVerificationRequest>(
  'SmileIDEnhancedDocumentVerificationView'
);

export const SmileIDSmartSelfieAuthenticationView = createSmileIDView<SmartSelfieAuthenticationRequest>(
  'SmileIDSmartSelfieAuthenticationView'
);

export const SmileIDSmartSelfieAuthenticationEnhancedView = createSmileIDView<SmartSelfieAuthenticationEnhancedRequest>(
...
export const SmileIDSmartSelfieEnrollmentView = createSmileIDView<SmartSelfieEnrollmentRequest>(
  'SmileIDSmartSelfieEnrollmentView'
);

export const SmileIDSmartSelfieEnrollmentEnhancedView = createSmileIDView<SmartSelfieEnrollmentEnhancedRequest>(
