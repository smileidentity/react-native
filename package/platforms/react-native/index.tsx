...
const SmileID = {
   ...
   */
  setAllowOfflineMode: (allowOfflineMode: boolean) =>
   ...
   */
  pollSmartSelfieJobStatus: (request: JobStatusRequest) => 
   ...
   * @param {number} numAttempts - The number of polling attempts before stopping.
   */
  pollDocumentVerificationJobStatus: (request: JobStatusRequest) => 
   ...
   * @param {number} numAttempts - The number of polling attempts before stopping.
   */
  pollBiometricKycJobStatus: (request: JobStatusRequest) => 
   ...
   * @param {number} numAttempts - The number of polling attempts before stopping.
   */
  pollEnhancedDocumentVerificationJobStatus: (request: JobStatusRequest) => 
